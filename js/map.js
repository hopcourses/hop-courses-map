...
// Hop Courses Map  
// map.js
// Sprint 2.7.4 (MapTiler Landscape + Cadrage optimisé)
...
function initialiserCarte(){
    ...
    // Intégration du style MapTiler Landscape (landscape-v4)
    L.tileLayer(
        "https://api.maptiler.com/maps/landscape-v4/{z}/{x}/{y}.png?key=ZVLCaLZfrUUaHWwdJ4rO",
        {
            maxZoom: 19,
            tileSize: 512,
            zoomOffset: -1,
...
/**
 * ----------------------------------------------------------
 * Centre la carte pour inclure la course uniquement (A et B)
 * ----------------------------------------------------------
 */
